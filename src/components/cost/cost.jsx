...
const Cost =()=>{
    ...
    return(
        <div className={styles.costWork}>
             ...
             <p>      Оплата производится в следующем порядке: 50 процентов перед началом работ и обмерами (при заключении договора) и 50 процентов при сдаче  при сдаче готового дизайн проекта. 
                ...
                Пример готового альбома с дизайном проектом отправляем на почту по запросу.</p> 
